...
The Tagalog Learning App implements a custom Spaced Repetition System (SRS) algorithm to help users optimize vocabulary retention. The core logic is located in `src/utils/srs.ts`.
