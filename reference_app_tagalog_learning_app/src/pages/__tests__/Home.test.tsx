    ...
    const mockLessons = [
        {
            ...
            cards: [
                { id: '1', tagalog: 'Kumusta?', english: 'How are you?', zhTW: '', zhCN: '' },
                { id: '2', tagalog: 'Salamat', english: 'Thank you', zhTW: '', zhCN: '' }
            ]
        },
        {
            id: 'animals',
            ...
            cards: [
                { id: 'ani1', tagalog: 'Aso', english: 'Dog', zhTW: '', zhCN: '' },
                { id: 'ani2', tagalog: 'Pusa', english: 'Cat', zhTW: '', zhCN: '' }
            ]
        }
    ];
    return {
